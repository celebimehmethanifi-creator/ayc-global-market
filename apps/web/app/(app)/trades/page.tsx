...
export default function TradesPage() {
  ...
  const stats = [
    ...
    { label:"Toplam Değer",    value:mounted ? fmt(totalValue)     : "-", sub:mounted ? `${totalPnlPct >= 0 ? "+" : ""}${totalPnlPct.toFixed(2)}%` : "-", icon:BarChart3, up: totalPnlUSD >= 0 },
      ...
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:10}}>
        <div>
          ...
          <p style={{fontSize:12,color:"var(--t3)",margin:"4px 0 0"}}>
            Demo portföy · $10,000 sanal bakiye ile başladın
          </p>
        </div>
